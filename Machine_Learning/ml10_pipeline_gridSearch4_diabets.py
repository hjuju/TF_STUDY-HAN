...
최적의 매개변수:  Pipeline(steps=[('scaler', MinMaxScaler()),
                ('RR',
                 RandomForestRegressor(max_depth=16, min_samples_leaf=14,
                                       min_samples_split=10, n_estimators=30,
                                       n_jobs=-1))])
best_score:  {'RR__n_jobs': -1, 'RR__n_estimators': 30, 'RR__min_samples_split': 10, 'RR__min_samples_leaf': 14, 'RR__max_depth': 16}
best_score:  0.4886273020976953
ic| R2: 0.42792369036507294
...
best_score:  {'RR__max_depth': 10, 'RR__min_samples_leaf': 8, 'RR__min_samples_split': 8, 'RR__n_estimators': 100, 'RR__n_jobs': -1}
best_score:  0.49236158515246214
ic| R2: 0.42222002514281476
'''
