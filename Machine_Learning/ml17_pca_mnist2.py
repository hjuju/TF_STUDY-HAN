...
model = Sequential()
model.add(Dense(units=154, activation='relu', input_shape=(28,28)))
model.add(Flatten())
...
'''
PCA(154)
ic| 'loss:', loss[0]: 0.20301192998886108
ic| 'accuracy', loss[1]: 0.9725000262260437


PCA(X)
ic| 'loss:', loss[0]: 0.24869416654109955
ic| 'accuracy', loss[1]: 0.9682999849319458
ic| f'{걸린시간}분': '1.1분'
