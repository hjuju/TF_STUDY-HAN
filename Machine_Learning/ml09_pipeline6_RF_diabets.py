...
model = make_pipeline(QuantileTransformer(), RandomForestRegressor()) # 스케일러, 모델
...
'''
RF + MinMax
ic| model_score: 0.3697998594001938
ic| R2: 0.3697998594001938

RF + standard
ic| model_score: 0.37969785945504964
ic| R2: 0.37969785945504964
