...
model = RandomizedSearchCV(RandomForestClassifier(), parameter, cv=kfold, verbose=1) # 사용할 모델, parameter(정의), cv 명시 /  텐서플로로 하면 모델에 텐서플로 모델이 들어가면 됨
...
최적의 매개변수:  RandomForestClassifier(criterion='entropy', max_depth=10, min_samples_leaf=12,
                       min_samples_split=16, n_estimators=50, n_jobs=-1)
best_score:  0.956043956043956

Fitting 5 folds for each of 10 candidates, totalling 50 fits
최적의 매개변수:  RandomForestClassifier(max_depth=6, min_samples_leaf=12, min_samples_split=20,
