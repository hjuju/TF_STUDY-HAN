...
for dt_key, dt_val in DATASETS.items():
    ...
    for tf_key, tf_val in TRAINABLE.items():
        for fg_key, fg_val in FLATTEN_GAP.items():
            transfer_learning = DenseNet121(weights='imagenet', include_top=False, input_shape=(32, 32, 3))
...
'''
[1] cifar_10_True__Flatten :: loss= 0.9491, acc= 0.7673
[2] cifar_10_True__GAP__2D :: loss= 0.8794, acc= 0.7666
[3] cifar_10_False_Flatten :: loss= 0.9539, acc= 0.6668
[4] cifar_10_False_GAP__2D :: loss= 0.9543, acc= 0.6659
[5] cifar100_True__Flatten :: loss= 2.2291, acc= 0.4809
[6] cifar100_True__GAP__2D :: loss= 2.2245, acc= 0.4862
[7] cifar100_False_Flatten :: loss= 2.3974, acc= 0.3833
[8] cifar100_False_GAP__2D :: loss= 2.4034, acc= 0.3834
