...
model.fit(x_train, y_train, epochs=1000, verbose=1, batch_size=8, validation_split=0.2, callbacks=[es, reduce_lr])
...
'''
ReduceLR
ic| 'loss:', loss[0]: 0.09622936695814133
ic| 'accuracy', loss[1]: 0.9629629850387573
