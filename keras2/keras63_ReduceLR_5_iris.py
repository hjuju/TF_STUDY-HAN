...
reduce_lr = ReduceLROnPlateau(monitor='val_loss', patience=5, mode=optimizer, verbose=1, factor=0.5) 
...
model.fit(x_train, y_train, epochs=1000, verbose=1, batch_size=16,validation_split=0.1,  shuffle=True, callbacks=[es, reduce_lr])
...
'''
ReduceLR
ic| 'loss:', loss[0]: 0.12160354107618332
