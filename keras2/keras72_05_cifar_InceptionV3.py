...
for dt_key, dt_val in DATASETS.items():
    ...
    for tf_key, tf_val in TRAINABLE.items():
        for fg_key, fg_val in FLATTEN_GAP.items():
            transfer_learning = InceptionV3(weights='imagenet', include_top=False, input_shape=(96, 96, 3))
...
'''
[1] cifar_10_True__Flatten :: loss= 0.7086, acc= 0.814
[2] cifar_10_True__GAP__2D :: loss= 0.6637, acc= 0.8171
[3] cifar_10_False_Flatten :: loss= 1.4487, acc= 0.5376
[4] cifar_10_False_GAP__2D :: loss= 1.3891, acc= 0.5463
[5] cifar100_True__Flatten :: loss= 4.3804, acc= 0.1265
[6] cifar100_True__GAP__2D :: loss= 2.132, acc= 0.4822
[7] cifar100_False_Flatten :: loss= 3.1135, acc= 0.2818
[8] cifar100_False_GAP__2D :: loss= 3.0992, acc= 0.2832
