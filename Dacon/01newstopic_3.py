...
model = Sequential()
model.add(Embedding(input_dim=45000, output_dim=200, input_length=14))
...
start = time.time()
model.fit(x_train, y_train, epochs=100, batch_size=128, validation_split=0.1, callbacks=[es, cp] )
