...
plt.rc('font', family=fm.FontProperties(fname="C:/Windows/Fonts/candara.ttf").get_name()) # for Windows OS user
...
for train_idx, valid_idx in skf.split(train_inputs[0], labels):
    ...
    np.save(f'./Dacon/_save/climate{now}_prediction.npy', prediction)
