...
# 트레인 테스트 스플릿 ㄷ붠 쓰는것보다, fit에서 validation data 나눠줌
...
model.fit(x_train,y_train, epochs=1000, batch_size=1, verbose=1,validation_split=0.3, shuffle=True) # validation data = 3개, 트레인데이터는 8개 -> 소수점은 내림
