...
from tensorflow.keras.layers import Dense, LSTM, Conv1D, Embedding, Flatten, Dropout, GlobalAveragePooling1D


#2. 모델 생성
model = Sequential()
model.add(Embedding(input_dim=1000000, output_dim=128, input_length=10 ))
