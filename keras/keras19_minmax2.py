...
x_train, x_test, y_train, y_test = train_test_split(x_scale, y, train_size=0.7, shuffle=True, random_state=70)
...
model1 = Sequential()
model1.add(Dense(256, input_dim=13, activation='relu'))
...
model1.fit(x_train, y_train, epochs=500,verbose=1, batch_size=8, shuffle=True)
