...
dense1 = Dense(512, activation='selu')(input1)
dense2 = Dense(400, activation='selu')(dense1)
dense3 = Dense(300, activation='selu')(dense2)
dense4 = Dense(256, activation='selu')(dense3)
dense5 = Dense(200, activation='selu')(dense4)
dense6 = Dense(128, activation='selu')(dense5)
dense7 = Dense(100, activation='selu')(dense6)
