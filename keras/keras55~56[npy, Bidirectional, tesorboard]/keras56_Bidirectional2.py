...
# 원 핫 인코딩 -> 라벨의 개수만큼 생김 (13, 5) -> 원핫 인코딩 후(13, 5, 28) -> 쓸모 없는 데이터만 너무 많아질 수 있음

from tensorflow.keras.models import Sequential
from tensorflow.keras.layers import Dense,LSTM, Embedding, Bidirectional #  -> onehot, vector화 까지 Embedding이 모두 처리해줌
